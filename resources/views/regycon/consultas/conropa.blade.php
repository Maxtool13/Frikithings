...
<html>
    ...
    <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                ...
                <a href="/reportes/reporteropa"><button type="button" class="btn btn-primary">Generar Reporte</button></a>  
                ...
                <thead>
                    ...
                    @foreach ($ropa as $ropas)
                                <tr>
                                    ...
                                    <td> {{$ropas->peso}}</td>
                                    <td>
                                    <a href="{{ route ('Ropa.show', $ropas->id)}}"><button type="button" class="btn btn-primary">Ver</button></a> 
                                    <form method="post" action="{{ url ('/Ropa/'.$ropas->id)}}">
                                    {{csrf_field() }}
                                    {{method_field('DELETE')}}
