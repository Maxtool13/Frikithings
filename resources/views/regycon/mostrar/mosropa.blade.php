        ...
        <div class="bg-cover clearfix pt-3">
            <h2 class="logo">FrikiThings</h2> 
                ...
                <div class="btn-group" role="group">
                    ...
                    <a class="dropdown-item" href="/regycon/registros/regropa">Registrar Ropa</a>
                    <a class="dropdown-item" href="/regycon/consultas/conropa">Consultar Ropa</a>
                ...
                <br>
                    ...
                    <form action="{{ url('/Ropa/'.$datosropa->id)}}" method="POST" id="chucha" enctype="">
                        ...
                        <input type="text" name="tipo" id="tipo" value="{{$datosropa->tipo}}" disabled="true">
                        <br>

                        <label for="Talla" id="blin">{{'Talla'}}</label>
                        <input type="text" name="talla" id="talla" value="{{$datosropa->talla}}" disabled="true">
                        <br>

                        <label for="Genero" id="blin">{{'Genero'}}</label>
                        <input type="text" id="cuak" name="genero" id="genero" value="{{$datosropa->genero}}" disabled="true">
                        <br>

                        <label for="Numero de lote" id="blin">{{'Numero de lote'}}</label>
                        <input type="text" id="cuak" name="nolote" id="nolote" value="{{$datosropa->nolote}}" disabled="true">
                        <br>

                        <label for="Origen" id="blin">{{'Origen'}}</label>
                        <input type="text" id="cuak" name="origen" id="origen" value="{{$datosropa->origen}}" disabled="true">
                        <br>

                        <label for="Peso kg" id="blin">{{'Peso kg'}}</label>
                        <input type="number" id="cuak" name="peso" id="peso" value="{{$datosropa->peso}}" disabled="true">
                        <br>

                        <center>
                        <a href="{{ url('/Ropa/'.$datosropa->id . '/edit' )}}"><button type="button" class="btn btn-success btn-lg">Ir a Editar</button></a>
