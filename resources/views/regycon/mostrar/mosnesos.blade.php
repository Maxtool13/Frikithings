            ...
            <h2 class="logo">FrikiThings</h2> 
                ...
                <br>
                    ...
                    <form action="{{ url('/Nesoberis/'.$datosneso->id)}}" method="POST" id="chucha" enctype="multipart/form-data">
                        ...
                        <input type="text" id="cuak" name="nombre" id="serie" value="{{$datosneso->nombre}}" disabled="true">
                        <br>

                        <label for="Serie" id="blin">{{'Serie'}}</label>
                        <input type="text" id="cuak" name="serie" id="serie" value="{{$datosneso->serie}}" disabled="true">
                        <br>

                        <label for="tamaño" id="blin">{{'Tamaño(cm)'}}</label>
                        <input type="number" id="cuak" name="tamaño" id="tamaño" value="{{$datosneso->tamaño}}" disabled="true">
                        <br>

                        <label for="peso" id="blin">{{'Peso(gr)'}}</label>
                        <input type="number" id="cuak" name="peso" id="peso" value="{{$datosneso->peso}}" disabled="true">
                        <br>
                        <label for="precio" id="blin">{{'Precio MXN'}}</label>
                        <input type="number"  id="cuak" name="precio" id="precio" value="{{$datosneso->precio}}" disabled="true">
                        <br>
                        ...
                        <center>
                        <br>
                        <a href="{{ url('/Nesoberis/'.$datosneso->id . '/edit' )}}"><button type="button" class="btn btn-success btn-lg">Ir a Editar</button></a>
