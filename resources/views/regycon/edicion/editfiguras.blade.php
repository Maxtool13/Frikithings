            ...
            <h2 class="logo">FrikiThings</h2> 
                ...
                <br>
                    ...
                    <form action="{{ url('/Figuras/'.$datosfiguras->id)}}" method="POST" id="chucha" enctype="">
                        ...
                        <input type="text" name="nombre" id="nombre" value="{{$datosfiguras->nombre}}">
                        <br>

                        <label for="serie" id="blin">{{'Serie'}}</label>
                        <input type="text" id="cuak" name="serie" id="serie" value="{{$datosfiguras->serie}}">
                        <br>

                        <label for="marca" id="blin">{{'Marca'}}</label>
                        <input type="text" id="cuak" name="marca" id="marca" value="{{$datosfiguras->marca}}">
                        <br>

                        <label for="peso(gr)" id="blin">{{'Peso(gr)'}}</label>
                        <input type="number" id="cuak" name="peso" id="peso" value="{{$datosfiguras->peso}}">
                        <br>

                        <label for="altura(cm)" id="blin">{{'Altura(cm)'}}</label>
                        <input type="number" id="cuak" name="altura" id="altura" value="{{$datosfiguras->altura}}">
                        <br>

                        <label for="empaque" id="blin">{{'Empaque'}}</label>
                        <input type="text" id="cuak" name="empaque" id="empaque" value="{{$datosfiguras->empaque}}">
                        <br>

                        <label for="precio" id="blin">{{'Precio MXN'}}</label>
                        <input type="number"  id="cuak" name="precio" id="precio" value="{{$datosfiguras->precio}}">
