...
<body>
    ...
    <div class="container">
        <center>
            <br>
    <h2>Registro de Prendas/Accesorios</h2>
        </center>
    ...
    <form action="{{url('/Ropa')}}" method="POST" id="chucha">

    @csrf

        <label for="Prendas/Accesorios" id="blin">{{'Prendas/Accesorios'}}</label>
        ...
        <input type="text" id="cuak" name="genero" id="genero">
        <br>

        <label for="Numero de lote" id="blin">{{'Numero de lote'}}</label>
        <input type="text" id="cuak" name="nolote" id="nolote">
        <br>

        <label for="Origen" id="blin">{{'Origen'}}</label>
        <input type="text" id="cuak" name="origen" id="origen">
        <br>
