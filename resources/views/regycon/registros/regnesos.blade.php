...
<head>
    ...
    <title>REGISTRO DE NESOBERIS</title>
</head>
...
<body>
    ...
    <h2>Registro de Nesoberis</h2>
        ...
        <form action="{{url('/Nesoberis')}}" method="POST" id="chucha" enctype="multipart/form-data">

                @csrf

            <label for="nombre" id="blin">{{'Nombre'}}</label>
            <input type="text" id="cuak" name="nombre" id="serie">
            <br>
            ...
            <input type="number" id="cuak" name="tamaño" id="tamaño">
            <br>
