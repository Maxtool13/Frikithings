...
<body>
    <header class="mt-0 pt-0">
        ...
        <div class="row ml-0 mr-0">
            <div class="col-md-6 pr-0">
                <div class="card">
                    <img class="card-img" src="{{asset('assets/images/left-img.jpg')}}" alt="">
            ...
            <div class="col-md-6 pl-0">
                <div class="card">
                    <img class="card-img" src="{{asset('assets/images/right-img.jpg')}}" alt="">
                    <div class="card-img-overlay d-flex align-items-center justify-content-center flex-column">
                        <p>DECOR</p>
                        <hr />
            ...
            <div class="col-md-3 pr-0 first">
                <div class="card">
                    <img class="card-img" src="{{asset('assets/images/architecture.png')}}" alt="">
            ...
            <div class="col-md-3 pl-0 pr-0">
                <div class="card">
                    <img class="card-img" src="{{asset('assets/images/interior.png')}}" alt="">
                    <div class="card-img-overlay">
                        <h5>Interior</h5>
                    </div>
                </div>
            ...
            <div class="col-md-3 pl-0 pr-0">
                <div class="card">
                    <img class="card-img" src="{{asset('assets/images/food.png')}}" alt="">
                    <div class="card-img-overlay">
                        <h5>Food</h5>
                    </div>
                </div>
            ...
            <div class="col-md-3 pl-0 last">
                <div class="card">
                    <img class="card-img" src="{{asset('assets/images/travel.png')}}" alt="">
                    <div class="card-img-overlay">
                        <h5>Travel</h5>
                    </div>
                </div>
    ...
    <div class="container-fluid video-player">
        <div class="container">
            <div class="screen embed-responsive embed-responsive-16by9">
                <iframe id="screen" src="{{asset('https://www.youtube.com/embed/YE7VzlLtp-4')}}" frameborder="0"
                ...
                <div class="owl-carousel owl-carousel4 owl-theme">
                    <div>
                        <div class="card"> <img class="card-img link-img"
                                data-link="https://www.youtube.com/embed/ujPNSC4JllE" src="{{asset('assets/images/play1.png')}}"
                                alt="">
                        </div>
                    </div>
                    <div>
                        <div class="card"> <img class="card-img link-img"
                                data-link="https://www.youtube.com/embed/rMT8CffVFMk" src="{{asset('assets/images/play2.png')}}"
                                alt="">
                    ...
                    <div>
                        <div class="card"> <img class="card-img link-img"
                                data-link="https://www.youtube.com/embed/bGC9f1Po6Q8" src="{{asset('assets/images/play3.png')}}"
                                alt="">
                    ...
                    <div>
                        <div class="card"> <img class="card-img link-img"
                                data-link="https://www.youtube.com/embed/yHk_sypSiXU" src="{{asset('assets/images/play4.png')}}"
                                alt="">
                    ...
                    <div>
                        <div class="card"> <img class="card-img link-img"
                                data-link="https://www.youtube.com/embed/7yoqm-kgKEk" src="{{asset('assets/images/play5.png')}}"
                                alt="">
            ...
            <div class="row vr-gallery">
                <div class="col-md-8 mb-4">
                    <div class="row">
                        <div class="col-md-12 col-lg-7 pr-0 pd-md">
                            <img src="{{asset('assets/images/gallery-img1.png')}}" alt="">
                        </div>
                ...
                <div class="col-md-4 pl-4 mb-4">
                    <div class="card">
                        <img class="card-img h-100" src="{{asset('assets/images/video-cover1.jpg')}}" alt="">
                ...
                <div class="col-md-8 mb-4 pr-0 pd-md">
                    <div class="card">
                        <img class="card-img h-100" src="{{asset('assets/images/gallery-img2.jpg')}}" alt="">
                        <div class="card-img-overlay">
                ...
                <div class="col-md-4 pl-4 mb-4">
                    <div class="card">
                        <img class="card-img-top" src="{{asset('assets/images/gallery-img3.jpg')}}" alt="">
                ...
                <div class="col-md-4 pl-4 mb-4">
                    <div class="card">
                        <img class="card-img h-100" src="{{asset('assets/images/video-cover2.jpg')}}" alt="">
                        <div class="card-img-overlay opacity text-center">
                            <a class="play-1" href="https://www.youtube.com/watch?v=vpO8sZDxOGI"><img
                                    src="{{asset('assets/images/play-icon.png')}}" alt=""></a>
                            <h5 class="card-title">Weekend In Boston</h5>
        ...
        <div class="play-list mt-5 pt-4">
            <div class="owl-carousel owl-carousel5 owl-theme">
                <div>
                    ...
                    <div class="card"> <img class="card-img link-img" src="{{asset('assets/images/news6.png')}}" alt="">
                        <div class="card-img-overlay">
                ...
                <div>
                    <div class="card"> <img class="card-img link-img" src="{{asset('assets/images/news2.png')}}" alt="">
                        <div class="card-img-overlay">
                            <div class="top-area"><a href="#" class="text-center d-block"><i
                                        class="far fa-heart"></i></a></div>
                            <div class="bottom-area">
                ...
                <div>
                    <div class="card"> <img class="card-img link-img" src="{{asset('assets/images/news3.png')}}" alt="">
                        <div class="card-img-overlay">
                            <div class="top-area"><a href="#" class="text-center d-block"><i
                                        class="far fa-heart"></i></a></div>
                            <div class="bottom-area">
                ...
                <div>
                    <div class="card"> <img class="card-img link-img" src="{{asset('assets/images/news4.png')}}" alt="">
                        <div class="card-img-overlay">
                            <div class="top-area"><a href="#" class="text-center d-block"><i
                                        class="far fa-heart"></i></a></div>
                            <div class="bottom-area">
                ...
                <div>
                    <div class="card"> <img class="card-img link-img" src="{{asset('assets/images/news5.png')}}" alt="">
                        <div class="card-img-overlay">
                            <div class="top-area"><a href="#" class="text-center d-block"><i
                                        class="far fa-heart"></i></a></div>
                            <div class="bottom-area">
    ...
    <footer class="container-fluid pt-5">
        ...
        <a href="#" class="text-white">FrikiThings</a>
        <a href="/regycon/registros/regnesos" class="text-white">//Registro de Nesoberis</a>
        <a href="/regycon/consultas/connesos" class="text-white">//Consulta de tabla</a>. 
